...
function separar(aux) {
    var peg = "", novVet = new Array();
    var sinais = "+*/^%()", numeros = "-0123456789.", sin = "-+*/^%()";
    ...
    if (peg[peg.length - 1] == "#")
        peg = peg.substring(0, peg.length - 1);
    else peg = peg;
...
function polonesa(text) {
    var help = 0, cont = 0, h1 = 0, h2 = 0, pos = 0, helper = 0;
    var novVet1 = new Array(), vetsin = new Array();
    var vetnum = new Array(), novo = new Array();
    var s = "+-*/^%()", n = "-0123456789.";
    ...
    for (var j = 0; j < novVet1.length; j++) {
        ...
        if (contem(s, novVet1[j]) || novVet1[j] == "-") {
            if (cont > 0) {
                ...
                else if (helper == 0 && novVet1[j] != "(" && novVet1[j] != ")" && pos > 0) {
                    vetsin.push(novVet1[j]);
                    cont++;
                    helper++;
                }
...
function resolve(ol) {
    var sin = "+*/-%^", z = true;
    var vetor = new Array(), resul = new Array();
    vetor = polonesa(ol);
    var conta = 0, resultado = 0;
...
function igual() {
    ...
    if (contem1(texto.value, "qwertyuiopasdfghjklçzxcvbnm"))
        ...
        var vetRec = new Array(), vetpol = new Array();
        var sinais = "+*/^%()", conta = 0;
